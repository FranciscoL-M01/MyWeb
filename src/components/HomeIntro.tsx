...
const HomeIntro = () => {
  return (
    <>
        <Box marginBottom="2rem" display={{base: "none", md: "block"}}>
        ...
        <Box marginBottom="2rem" display={{base: "block", md: "none"}}>
            <Text textAlign="center" color="black" fontWeight="bold" textStyle="xl" fontFamily="Lora">Hello,</Text>
            <Text textAlign="center" color="black" fontWeight="bold" textStyle="3xl" fontFamily="Lora">my name if Francisco.</Text>
            <Text textAlign="center" color="black" textStyle="2xl" fontFamily="Lora" margin="1rem 5rem">
            I am an aspiring Front-end Developer who’s constantly expanding their knowledge base with new skills.
            I’m inspired to create visually stunning and user friendly experiences for a polished final product.
            My career goals revolve around the planning, designing and creation of web applications.
            </Text>
